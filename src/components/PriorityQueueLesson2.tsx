    ...
    <div className="min-h-screen flex flex-col bg-background dark:bg-background">
      ...
      <div className="flex-1 flex flex-col p-6 max-w-3xl mx-auto w-full pt-24 pb-6">
        ...
        <div className="flex-1">
          ...
          >
            <h2 className="mb-4 text-text-primary dark:text-text-primary text-xl font-bold">Real World Priority Queues</h2>
            ...
            <div className="grid gap-4">
              ...
              <motion.div 
                ...
                className="group relative overflow-hidden bg-card dark:bg-card rounded-2xl border-2 border-border dark:border-border hover:border-[#FF4B4B] dark:hover:border-[#FF4B4B] hover:shadow-[0_4px_0_#D93535] dark:hover:shadow-[0_4px_0_#D93535] transition-all cursor-default"
              >
                ...
                <div className="p-5 flex items-start gap-4 relative z-10">
                  <div className="w-16 h-16 bg-[#FFE8E8] dark:bg-[#4A2020] rounded-2xl flex items-center justify-center text-3xl shadow-sm border-b-4 border-[#FF4B4B] dark:border-[#FF4B4B]">
                    🏥
                  </div>
                  <div className="flex-1">
