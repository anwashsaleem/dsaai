          ...
          <div className="px-6 pb-6 relative">
              ...
              <div className="relative -mt-16 mb-4 flex justify-between items-end">
                  ...
                  <button
                      ...
                      className="mb-2 px-4 py-2 bg-[#F7F7F7] border-2 border-[#E5E5E5] rounded-xl font-bold text-sm text-[#4B4B4B] hover:bg-[#E5E5E5] transition-colors flex items-center gap-2"
                  >
              ...
              <div className="mb-6">
                  ...
                  <div className="text-[#AFAFAF] font-bold text-sm mt-1">
                      @{username}
                  </div>
              </div>
